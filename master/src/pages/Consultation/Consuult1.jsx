...
function Consuult1() {
  return (
    <div>
        {/* hero */}
      <section></section>
      <div className="relative mt-2 bg-[url('assets/c.png')] bg-cover bg-center bg-grayRoot ">
  ...
  <div className="px-4 py-8 mx-auto my-2 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
      <h2 className="mb-36 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
        The quick, brown fox
