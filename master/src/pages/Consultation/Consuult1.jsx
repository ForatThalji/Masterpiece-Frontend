...
function Consuult1() {
  return (
    <div>
      ...
      <div className="relative mt-2 bg-[url('assets/c.png')] bg-cover bg-no-repeat bg-center w-full bg-grayRoot h-[600px]">
  
  <div className="absolute inset-x-0 bottom-0">
  
  </div>
  <div className="px-4 py-8 mx-auto my-2 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
      <h1 className="mb-36 font-irish text-3xl leading-loose text-white sm:text-4xl sm:leading-none">
      Discover the Best for Your Skin:
...
<section className="bg-white dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
    <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
      ...
      Meet our dedicated team of skincare experts, committed to providing personalized solutions and unparalleled care for your skin's unique needs.
      </p>
    </div>
